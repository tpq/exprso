...
setGeneric("arraySubset", function(object, ...) standardGeneric("arraySubset"))
setGeneric("splitSample", function(object, ...) standardGeneric("splitSample"))
setGeneric("splitStratify", function(object, ...) standardGeneric("splitStratify"))
